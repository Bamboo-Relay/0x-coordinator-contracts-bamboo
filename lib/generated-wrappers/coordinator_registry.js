...
var CoordinatorRegistryContract = /** @class */ (function (_super) {
    ...
    function CoordinatorRegistryContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = CoordinatorRegistryContract.deployedBytecode; }
        var _this = _super.call(this, 'CoordinatorRegistry', CoordinatorRegistryContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        ...
        CoordinatorRegistryContract.ABI().forEach(function (item, index) {
    ...
    CoordinatorRegistryContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, CoordinatorRegistryContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    CoordinatorRegistryContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, CoordinatorRegistryContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    CoordinatorRegistryContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = CoordinatorRegistryContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    CoordinatorRegistryContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    CoordinatorRegistryContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    CoordinatorRegistryContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    * @returns coordinatorEndpoint Endpoint of the Coordinator as a string.
     */
    CoordinatorRegistryContract.prototype.getCoordinatorEndpoint = function (coordinatorOperator) {
        var self = this;
        assert_1.assert.isString('coordinatorOperator', coordinatorOperator);
        var functionSignature = 'getCoordinatorEndpoint(address)';
        return {
     ...
     */
    CoordinatorRegistryContract.prototype.setCoordinatorEndpoint = function (coordinatorEndpoint) {
        var self = this;
        assert_1.assert.isString('coordinatorEndpoint', coordinatorEndpoint);
        var functionSignature = 'setCoordinatorEndpoint(string)';
        return {
    ...
    CoordinatorRegistryContract.contractName = 'CoordinatorRegistry';
