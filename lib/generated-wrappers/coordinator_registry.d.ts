...
export declare class CoordinatorRegistryContract extends BaseContract {
    ...
    * @returns coordinatorEndpoint Endpoint of the Coordinator as a string.
     ...
     */
    subscribe<ArgsType extends CoordinatorRegistryEventArgs>(eventName: CoordinatorRegistryEvents, indexFilterValues: IndexedFilterValues, callback: EventCallback<ArgsType>, isVerbose?: boolean, blockPollingIntervalMs?: number): string;
    /**
     ...
     */
    getLogsAsync<ArgsType extends CoordinatorRegistryEventArgs>(eventName: CoordinatorRegistryEvents, blockRange: BlockRange, indexFilterValues: IndexedFilterValues): Promise<Array<LogWithDecodedArgs<ArgsType>>>;
